...
export class ModerationPoliciesDomainService {
  ...
  async evaluateArticleFreeze(context: ArticleFreezeContext): Promise<void> {
    ...
    throw new Error(
      'ModerationPoliciesDomainService.evaluateArticleFreeze not implemented',
    );
  }
  ...
  async evaluateBlockSource(context: BlockSourceContext): Promise<void> {
    ...
    throw new Error(
      'ModerationPoliciesDomainService.evaluateBlockSource not implemented',
    );
  }
  ...
  async evaluateUserRestriction(
    ...
    throw new Error(
      'ModerationPoliciesDomainService.evaluateUserRestriction not implemented',
    );
  }
}
