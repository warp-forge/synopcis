...
describe('AuthController', () => {
  ...
  describe('login', () => {
    ...
    it('should throw UnauthorizedException for an invalid user', async () => {
      ...
      await expect(
        controller.login({ nickname: 'invalid', password: 'password' }),
    ...
    it('should throw UnauthorizedException for an invalid password', async () => {
      ...
      await expect(
        controller.login({ nickname: 'test', password: 'wrongpassword' }),
      ).rejects.toThrow(UnauthorizedException);
    });
  });
  ...
  describe('register', () => {
    it('should create a new user', async () => {
      ...
      expect(mockUserDomainService.create).toHaveBeenCalledWith(
