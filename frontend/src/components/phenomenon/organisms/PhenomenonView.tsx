...
import { Box, TypographyStylesProvider, Group, Badge, Drawer, Stack, Paper, Text, Anchor, ActionIcon, Tooltip } from '@mantine/core';
import ReactMarkdown from 'react-markdown';
import BlockHistoryModal from '@/components/history/organisms/BlockHistoryModal';

// We inline IconLayersLinked, IconExternalLink, and IconHistory to avoid adding more dependencies
...
const IconHistory = ({ size = 24 }: { size?: number }) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 8l0 4l2 2" /><path d="M3.05 11a9 9 0 1 1 .5 4m-.5 5v-5h5" /></svg>
);
  ...
  return (
    <Box mb="xl" pos="relative">
      <Group align="flex-start" wrap="nowrap">
        ...
        <Group mt="xs" ml="sm" gap="xs" style={{ flexShrink: 0 }} align="center">
          ...
          <Tooltip label="View History">
            <ActionIcon variant="light" color="gray" onClick={() => setHistoryOpened(true)} aria-label="View history">
              <IconHistory size={16} />
            </ActionIcon>
          </Tooltip>
        </Group>
